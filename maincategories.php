...
<table id="ctable" class="table table-hover table-striped table-bordered"  style="width:700px; margin: 0 auto;">
    <thead><tr><th></th><th>Name</th><th>Ukr name</th><th>Letter</th><th>Color</th><th style="width:85px;">Actions</th></tr></thead>
    <tbody>
<?php
...
?>
           ...
           <div id="addform">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="parent" autocomplete="off">
                            ...
                            <?php
                             foreach($cats as $row){
                                 if($crow['parent'] == $row['id']){$act = 'selected="selected" ';}else{$act = '';}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="color" id="color" value="<?php echo $crow['color'];?>" class="xlarge"/>
                    </div>
                </div>
                <div class="control-group">
