...
<div class="content">
    <?php if (isset($_POST['update'])): ?>
        ...
        <?php else: ?>
            ...
            <form method="POST"><input type="hidden" name="update" value="true" />
                <button type="submit" name="force_update" value="true"
                        onclick="return confirm('Are you sure you want to force update? It could take long time and traffic.')">
                    Force update
                </button>
            </form></p>
        <?php endif; ?>
